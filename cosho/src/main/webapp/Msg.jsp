...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/icons.css" /> ">
		<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/all.css" /> ">		<style>
	...
	<header>
			<div class="container">
				...
				<%-- <div id="topheader">
						...
						<ul>
								<li><a class="viewCart"></a>WELCOME ${user_name}!</a></li>
							<li><a class="viewCart" href="viewCart">View Cart</a></li>
				...
				<div id="branding">
					<div id="brandTag">
						<img src="">
						<a href="/cosho/home.jsp">Cosho</a><br>
